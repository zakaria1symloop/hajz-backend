...
class HotelWallet extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(WalletTransaction::class, 'hotel_wallet_id')->orderBy('created_at', 'desc');
    }

    public function withdrawalRequests(): HasMany
    {
        return $this->hasMany(WithdrawalRequest::class, 'hotel_wallet_id')->orderBy('created_at', 'desc');
    }
    ...
    public function releaseToAvailable(float $amount, ?int $reservationId = null): WalletTransaction
    {
        return DB::transaction(function () use ($amount, $reservationId) {
            ...
            return $this->transactions()->create([
                ...
                'description' => 'Balance released after checkout',
            ]);
        });
    }
